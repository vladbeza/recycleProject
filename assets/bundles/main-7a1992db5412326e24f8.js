...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__api_get__ = __webpack_require__(34);
...
function Main(props) {
    return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        ...
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2__api_get__["a" /* default */], null)
    );
}
...
class PostsList extends React.Component {
    ...
    componentDidMount() {
        __WEBPACK_IMPORTED_MODULE_0_axios___default.a.get("http://127.0.0.1:8000/api/v0/news_all/").then(response => {
    ...
    render() {
        const posts = this.state.postContent.map(postData => {
            return React.createElement(
                ...
                React.createElement('img', { src: postData.short_image }),
                React.createElement(
                    'p',
                    { className: 'post-meta' },
                    React.createElement(
